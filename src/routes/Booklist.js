...
import { Input, Select, List, Pagination , Space, Row, Col,Divider ,Typography } from 'antd';
    ...
    render() {
        ...
        return (
            <Layout>                
                <Row>
                    <Col flex="300px">
                        <Link style={{ textDecoration: 'none' }}><img width={300} src='https://im2.book.com.tw/image/getImage?i=https://www.books.com.tw/img/001/084/59/0010845956_bc_01.jpg&v=5e204961&w=655&h=609'></img></Link>
                    ...
                    <Col flex="auto">
                        ...
                        <p style={{marginBottom: '5px'}}><Text>優秀生態畫家、金獎編輯團......<Link>more</Link></Text></p>  
                    </Col>
                </Row>
                <Divider />
                <Row>
                    ...
                    <Col flex="auto" style={{marginTop:22}}>
                        ...
                        <p style={{marginBottom: '5px'}}><Text>源留下紀錄......<Link>more</Link> </Text></p>        
                    </Col>
                </Row>
                <Divider />
                <Row>
                    ...
                    <Col flex="auto"  style={{marginTop:22}}>
                        ...
                        <p style={{marginBottom: '5px'}}><Text>潮溼的生態......<Link>more</Link></Text></p>  
                ...
                <Row>
                    ...
                    <Col flex="auto"  style={{marginTop:22}}>
                        ...
                        <p style={{marginBottom: '5px'}}><Text>物有進一步的認識，體驗大雪山不一樣......<Link>more</Link></Text></p>   
                    </Col>
                </Row>
                <Divider />
                <Row>
                    ...
                    <Col flex="auto"  style={{marginTop:22}}>
                        ...
                        <p style={{marginBottom: '5px'}}><Text>一、棲蘭山地區之地理環境......<Link>more</Link></Text></p>   
                    </Col>
                </Row>
                <Divider />
                <Row>
                    ...
                    <Col flex="auto">
                        ...
                        <p style={{marginBottom: '5px'}}><Text>的賞蕨圖鑑台灣雖是蕞爾小島，卻是......<Link>more</Link></Text></p> 
                    </Col>
                </Row>
                <Divider />
                <Row>
